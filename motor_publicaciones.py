...
class Autor:
    ...
    def publicar(self, tipo: str, titulo: str, contenido: str):
        ...
        nueva_publicacion = FabricaPublicaciones.crear_publicacion(
...
if __name__ == "__main__":
    ...
    autor.publicar(
        ...
        "Los algoritmos dominarán la optimización de procesos...",
    )
    print("\n")
    autor.publicar(
        "post", "¡Hola mundo!", "Este es mi primer post en la plataforma. ¡Saludos!"
    )
